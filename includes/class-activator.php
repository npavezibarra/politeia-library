...
class Politeia_Reading_Activator {
    ...
    private static function migrate_books_hash_and_unique() {
        ...
        self::maybe_add_unique($books, 'uniq_title_author_hash', ['title_author_hash']);
    }
    ...
    private static function ensure_unique_user_book() {
        ...
        self::maybe_add_unique($ub, 'uniq_user_book', ['user_id','book_id']);
        self::maybe_add_index($ub, 'idx_user', ['user_id']);
        self::maybe_add_index($ub, 'idx_book', ['book_id']);
    }
